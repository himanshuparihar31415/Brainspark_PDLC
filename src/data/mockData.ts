...
export const INITIAL_TASKS: Task[] = [
   ...
   * Other projects.
   *
   * Everything above sits on Mobile Banking V2, which made My Activity's
   * cross-project grouping and the critical-elsewhere rail structurally
   * unreachable — there was never a second project to group. These are the
   * other four projects' work, weighted so the panel has something true to
   * show: two stopped, one overdue, one approval left sitting, and some
   * ordinary in-flight work so not everything reads as an alarm.
   */
  {
    id: 'task-x1',
    projectId: 'p-wealth-ai',
    ...
    title: 'Model card sign-off for the advice engine',
    project: 'AI Wealth Advisor Engine',
    module: 'SpecAI',
    assignee: 'Elena Rostova',
    priority: 'High',
    status: 'Blocked',
  ...
  },
  {
    ...
    title: 'Backtest harness for suitability scoring',
    project: 'AI Wealth Advisor Engine',
    module: 'IntelliQA',
    assignee: 'Priya Sharma',
    priority: 'Medium',
  ...
  },
  {
    ...
    title: 'Cut over the payments schema to the new cluster',
  ...
  },
  {
    ...
    title: 'Approve the rollback runbook for wave 2',
    project: 'Cloud Core Modernization',
    module: 'Release Pulse',
    assignee: 'Michael Chang',
    priority: 'Medium',
    ...
    tokens: 410000,
    reviewHoursOpen: 63,
    artifactTitle: 'Runbook: wave-2 rollback and data reconciliation',
    artifactSummary:
      'Covers partial-failure recovery and the reconciliation query set. Two steps still reference the retired bastion host.',
  },
  {
    id: 'task-x5',
    projectId: 'p-acme-portal',
    ...
    title: 'Partner onboarding flow — document upload step',
    project: 'Acme B2B Partner Portal',
    module: 'ProtoAI',
    assignee: 'Alex Rivera',
    priority: 'High',
    status: 'In Progress',
  ...
  },
  {
    ...
    title: 'Approve the partner API contract',
    project: 'Acme B2B Partner Portal',
    module: 'Architect Hub',
    assignee: 'Jordan Vance',
    priority: 'Medium',
    ...
    tokens: 540000,
    reviewHoursOpen: 31,
    artifactTitle: 'OpenAPI 3.1: partner-facing surface',
    artifactSummary:
      'Twelve endpoints, cursor pagination throughout. Rate-limit headers are described but not yet agreed with the partner.',
  },
  {
    id: 'task-x7',
    ...
    title: 'Shipment event ingestion from the carrier feed',
