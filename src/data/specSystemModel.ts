...
export const NODES: SysNode[] = [
  ...
  { id: 'scr-login', label: 'Login Screen', kind: 'screen', system: 'Design' },
  { id: 'scr-pin', label: 'PIN Fallback', kind: 'screen', system: 'Design' },
  { id: 'scr-device', label: 'Device Registration', kind: 'screen', system: 'Design' },
  {
    id: 'scr-biometric',
  ...
  { id: 'svc-risk', label: 'Risk Engine', kind: 'service', system: 'Architecture' },
  { id: 'svc-notify', label: 'Notification Service', kind: 'service', system: 'Architecture' },
  { id: 'svc-secmon', label: 'Security Monitoring', kind: 'service', system: 'Architecture' },
  { id: 'gw-oauth', label: 'OAuth Gateway', kind: 'service', system: 'Architecture' },

  { id: 'api-verify', label: 'POST /auth/verify', kind: 'endpoint', system: 'APIs' },
  { id: 'api-token', label: 'POST /auth/token', kind: 'endpoint', system: 'APIs' },
  { id: 'api-devices', label: 'GET /devices', kind: 'endpoint', system: 'APIs' },
  { id: 'api-register', label: 'POST /devices/register', kind: 'endpoint', system: 'APIs' },
  { id: 'api-profile', label: 'PATCH /profile', kind: 'endpoint', system: 'APIs' },
  {
    id: 'api-biometric',
  ...
  { id: 'repo-mobile', label: 'mobile-app', kind: 'repo', system: 'Git' },
  { id: 'repo-auth', label: 'authentication-service', kind: 'repo', system: 'Git' },
  { id: 'repo-device', label: 'device-registry', kind: 'repo', system: 'Git' },

  { id: 'tst-oauth', label: 'OAuth suite', kind: 'test', system: 'Tests', detail: '38 cases' },
  { id: 'tst-pin', label: 'PIN fallback suite', kind: 'test', system: 'Tests', detail: '12 cases' },
  { id: 'tst-session', label: 'Session timeout', kind: 'test', system: 'Tests', detail: '4 cases' },
  { id: 'tst-device', label: 'Device registration', kind: 'test', system: 'Tests', detail: '9 cases' },
